package woodspring.springtoronto.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "woodspring.springtoronto.repository",
        entityManagerFactoryRef = "entityManagerFactory",
        transactionManagerRef = "transactionManager")
@EnableTransactionManagement
public class SpringTorontoConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "woodspring.springtoronto.entity" });
